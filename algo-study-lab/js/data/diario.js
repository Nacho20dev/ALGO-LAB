...
export const diarioClases = [
    {
        ...
        resumen: "Vimos cómo Java reserva espacio contiguo en el Heap para los arrays. La importancia del índice 0.",
        ...
        pendiente: "Repasar la diferencia entre null y array vacío.",
        linkEjercicio: 1
    },
    {
        id: 2,
        ...
        resumen: "Análisis profundo del Bubble Sort y por qué es ineficiente para grandes volúmenes de datos.",
        joya: "El ordenamiento burbuja es el más simple pero el que más ciclos de CPU desperdicia.",
        codigo: "if (v[j] > v[j+1]) { ... } // El corazón del intercambio",
        pendiente: "Investigar Selection Sort para comparar rendimientos.",
        linkEjercicio: 10
    }
];